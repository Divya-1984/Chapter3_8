...
public class ScreenShotExampleTest {
   // String driverPath = "";
    ...
    public void linkedInRegistrationShouldFail() {
        driver.findElement(By.id("reg-firstname")).sendKeys("Ripon");//Correct ID for First name
        //driver.findElement(By.id("last-name")).sendKeys("Al Wasim");//Correct ID for Last name
        driver.findElement(By.id("reg-lastname")).sendKeys("Al Wasim");//Incorrect ID for Last name
